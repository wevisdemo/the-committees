      ...
      <ModalDetail open={open} onClose={() => setOpen(false)}>
        <div className="w-full md:w-[600px] md:mt-10 relative pb-10 px-5  text-start text-[#2322BC] mx-auto bg-white md:rounded-lg  flex flex-col items-center">
          ...
          <p className="b5 mt-5">
            ...
            ในรูปแบบไฟล์นามสกุล PDF โดย รวบรวมเฉพาะระเบียบวาระที่ 3 และ 4
            ซึ่งมีเนื้อหาเกี่ยวกับ การพิจารณาระเบียบวาระที่แต่ละ กมธ.
            ประชุมในแต่ละครั้ง
          </p>
          <p className="b5 mt-5">
            เครื่องมือที่ใช้ในการดึงข้อมูลจากไฟล์คือ Gemini 2.0 flash
            ผ่านคำสั่งตั้งต้น เมื่อการดึงข้อมูลเสร็จสิ้น ข้อมูล
            จะถูกนำเอาไปฟิลเตอร์เพื่อหาข้อผิดพลาด เช่น ตัวเลข
            หัวข้อตรงกับเอกสารหรือไม่, มีเนื้อหาหัวข้อครบถ้วน หรือไม่,
          ...
          <p className="b5 mt-5">
            ...
            flash ดึงซ้ำด้วยคำสั่งเดิม และถูกตรวจ เช็กอีกรอบ
          </p>
          <p className="b5 mt-5">
            เมื่อการดึงข้อมูลเสร็จสิ้น ขั้นตอนหลังจากนั้นคือการรวม
            ข้อมูลทั้งหมดและตรวจเช็กไฟล์การประชุมที่หายไปหรือ ตกหล่น
            เพื่อเก็บรวมรวมให้ครบถ้วนและใช้เครื่องมือเดิม
            ในการดึงข้อมูลจากไฟล์ที่ตกหล่นเหล่านี้อีกครั้ง โดยมี
            บางกรณีที่ไฟล์บันทึกการประชุมไม่สามารถใช้งานได้หรือ ขึ้นสถานะว่า
            error ทำให้ไม่ถูกรวมอยู่ในฐานข้อมูล ในส่วน
            ของไฟล์ข้อมูลที่ยังมีข้อผิดพลาด ไม่มีใน API หรือใน กรณีอื่น ๆ
